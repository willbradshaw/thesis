...
# Get all ranges
ranges_tab <- suppressMessages(read_tsv(inpath_ranges))
...
altrack_cut_cmd <- AlignmentsTrack(inpath_bam_cmd,
                               ispaired = TRUE,
...
altrack_cut_cz1 <- AlignmentsTrack(inpath_bam_cz1,
                                   ispaired = TRUE,
                                   type = c("coverage", "sashimi"),
                                   chromosome = chr_name[["CZ1"]],
                                   from = 1,
...
altrack_cut_cz2 <- AlignmentsTrack(inpath_bam_cz2,
                                   ispaired = TRUE,
                                   type = c("coverage", "sashimi"),
                                   chromosome = chr_name[["CZ2"]],
                                   from = 1,
