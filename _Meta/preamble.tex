...
\RequirePackage[backend=biber, citestyle=numeric-comp, style=nature, intitle = true, sorting=none,
	natbib=true, maxnames=3, minnames=1, url=false, giveninits=true, sortcites=true, date=year,
	doi=false,isbn=false]{biblatex}
\renewbibmacro{in:}{\ifentrytype{article}{}{\printtext{\bibstring{in}\intitlepunct}}}
%\bibliography{References/references} %Location of references.bib only for biblatex
\bibliography{D_References/1_Introduction,
	D_References/2_Methods,
	D_References/3_Locus,
	D_References/4_IgSeq,
	D_References/5_Appendices}
%D_References/references.bib}
