...
\begin{threeparttable}
\begin{tablenotes}
\item[1] \textit{P. playfairii} \igh{Z} \cz{1}--\cz{2} appear to be derived from \igh{Z}A, while the other exons are of uncertain subclass origin (\Cref{fig:ppl-cz-aln}).
\end{tablenotes}
\end{threeparttable}
\end{minipage}
...
\begin{figure}
	...
	\caption[Subclass affinity of \textit{Pachypanchax playfairii} \igh{Z}]{\textbf{Subclass affinity of \textit{Pachypanchax playfairii} \igh{Z}:} 
	Boxplots of Needleman-Wunsch alignment scores between the amino-acid sequences of\textit{P. playfairii} \cz{} exons and those of seven other cyprinodontiform species, demonstrating the differing affinity of diferent \textit{P. playfairii} exons for the three \igh{Z} subclasses.}
