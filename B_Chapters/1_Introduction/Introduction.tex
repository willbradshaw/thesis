...
% TODO: Dunn-Walters 2010 has a good B-cell subtype diagram
...
%The B cells that are positively selected divide rapidly
%and form memory cells or long-lived plasma cells
%whilst those that are negatively selected die. The
%selection of B cells in the germinal centre requires the
%help of T cells and follicular dendritic cells that
%provide survival signals and display antigens to the B
%cell. \parencite{ademokun2010ageing} <- more good summaries here
...
Similar declines in immune functionality are also observed in other aged model organisms, and have been especially well-studied in mice, whose ...
...
%Some mouse studies have reported a decrease in the size and number of germinal centres responding to antigenic challenge in aged mice, while others have not observed such a decline \parencite{caruso2009immunosenescence}. In some cases, age-related changes in GC activity appear to differ between different secondary lymphoid organs \parencite{caruso2009immunosenescence}, suggesting these changes may not be detected in human studies of peripheral blood.
%In addition, the number and size of haematopoietically-active bone-marrow regions declines with age as fat deposits accumulate in the marrow cavity \parencite{siegrist2009extremes}, reducing the size of the primary haematopoietic niche.

% TODO: Discuss repertoires here, or at the end?
...
In both humans and mice, B-cells from older individuals exhibit impaired class-switch recombination capacity, possibly as a result of decreased AID expression \parencite{montecino2013immunosenescence,blomberg2013age,frasca2011age}. AS CSR enables the generation of antibodies with the same specificity but different effector functions, it is very important for an effective humoral immune response in mammals \parencite{frasca2011age}, and the loss of CSR capacity is an important contributor to humoral immunosenescence in these species; however, as CSR is not present in teleost fishes, ...
...
As a result, older humans are thought to exhibit a greater reliance on immune memory compared to the \naive repertoire, leading to impaired reperoire flexibility in response to novel or mutated antigens \parencite{henry2019influenza}. % Is this in the right section?
...
Conversely, both humans and mice exhibit increased total baseline titres of serum antibody%, though the quality of these antibodies is degraded. % Frasca 2009 or better source

In mice, total baseline titres of serum antibody protein increase with age, suggesting that the problem is with generating specific humoral responses rather than antigen production \textit{per se} \parencite{speziali2009specific}; however, it is worth noting here that IGHM titres were not found to change with age in these mice, suggesting that this finding may not generalise to species lacking class-switch recombination.

The antibodies themselves are also thought to decline in quality with age, with older individuals producing 

Despite this, polyspecific and autoreactive antibodies increase in prevalence in ... with age, suggesting a breakdown in the primary B-cell selection mechanisms discussed in ... . This breakdown may even be a direct result of the decline in the number of surviving B-cell progenitors: as the number of immature B-cells competing for antigen falls, so does the strigency of selection as less-favoured cells can still receive enough growth signals to survive \parencite{ademokun2010ageing}.


These new autoantibodies usually do not lead to autoimmune disease in the elderly \parencite{siegrist2009extremes}, possibly due to their generally low antigen-affinity, but are thought to contribute to ...
...
The titre of antigen-specific serum antibodies is a well-established measure of the quality of a humoral immune response to antigen challenge, with a high titre associated with better recovery and more effective vaccination \parencite{dunnwalters2010bcellageing}. 
...
Blood titres of specific antibody produced in response to a wide range of vaccines decline in elderly human patients \parencite{ademokun2010ageing},

Similar deficiencies have been observed in the response of elderly patients to a wide range of vaccines, including hepititis, tetanus, diphtheria, tick-borne encephalitis and pneumococcus \parencite{dunnwalters2010bcellageing}
...
Many of the findings reported above are specific to IGHG or IGHA antibodies, which are the dominant serum and mucosal antibodies, respectively, in mice and humans, and may not generalise to species lacking class-switch recombination.
