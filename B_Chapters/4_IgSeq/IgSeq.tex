...
% TODO: Citation for purpose and necessity of PhiX spike-in (also in methods)template switching
...
\section{Establishing \igseq in turquoise killifish: pilot study} % TODO: Better section title? See what Dario says.
...
\label{fig:igseq-pilot-functional-vscores} % TODO: Citation needed for Kernel density plot
\end{figure}
