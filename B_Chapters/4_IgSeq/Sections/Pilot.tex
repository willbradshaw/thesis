...
\caption[Clone-size correlation between pilot replicates]{\textbf{Clone-size correlation between pilot replicates:} Boxplots showing distribution of Pearson's product-moment correlation coefficients of clone sizes for each pair of replicates, as measured by the number of unique sequences per clone in each replicate. Clones absent in a given replicate were given a size of zero.}
