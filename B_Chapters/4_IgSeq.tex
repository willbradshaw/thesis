...
Once a well-characterised \igh{} gene locus is available for a species, the constant- and variable-region sequences it contains can be used to sample the antibody repertoire of that species via specialised DNA- or RNA-sequencing protocols, known collectively as immune repertoire sequencing, immunoglobulin sequencing, or \igseq. These protocols ...
...
\caption{Unique nonfunctional sequences available for model inference with \program{IGoR}}\label{tab:igseq-ageing-igor-seqs}
