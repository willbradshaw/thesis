...
% TODO: Reference figures and sections in results part
% TODO: Link to intro chapter
...
% Discuss most important results:
% - Decline in clonal diversity with age in both whole-body and gut
% - Decline in VJ diversity with age in gut and large clones in whole-body; discuss difference, link to stability in generative repertoire with age
% - Lack of change with microbiota transfer
% - First experiment to specifically investigate ageing of mucosal immune repertoires?

% Things not done:
% - SHM
% - Primary selection
% - Clonal selection
% - Light chains / paired repertoire
% - Single-cell sequencing
% - Other immune organs
% - Developmental / whole-life evolution of repertoire
% - Correlation with microbiome
% - Distinguishing between changes resulting from learning vs decay
% - IGHD
% - TM vs secretory

% Roundup and final flourish
