###############################################################################
## Nothobranchius furzeri range table inference                              ##
###############################################################################
...
nfu_locus_path <- "../_Data/locus/complete/nfu.fasta"
...
jh_aa_path <- "../_Data/segments/nfu/nfu_jh_aa.fasta"
ch_nt_path <- "../_Data/constant/nfu/nfu_ch_nt_exons.fasta"

# Paths to RSS sequences
vh_rss_path <- "../_Data/rss/nfu/nfu_vh_rss.fasta"
dh_rss_path <- "../_Data/rss/nfu/nfu_dh_rss.fasta"
jh_rss_path <- "../_Data/rss/nfu/nfu_jh_rss.fasta"

# Output paths
for (segtype in paste0(c("v", "d", "j", "c"), "h")){
  assign(paste0("rangename_", segtype), paste0("nfu-", segtype, "-ranges.tsv"))
  assign(paste0("tablename_", segtype), paste0("nfu-", segtype, "-coords"))
}
rangename_all <- "nfu-locus-ranges.tsv"
...
# Locus
locus_unmasked <- readDNAStringSet(nfu_locus_path)
