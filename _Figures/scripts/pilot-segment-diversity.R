...
tab_path <- paste0("../_Data/changeo/spectra/pilot-", segments, 
                   "-diversity_seqs-", seqset, "_copy-", copy, ".tsv")
tab_path_crossrep <- paste0("../_Data/changeo/spectra/pilot-", segments, 
                   "-diversity_crossrep_seqs-", seqset, "_copy-", copy, ".tsv")
...
tab_crossrep <- import_div(tab_path_crossrep)
