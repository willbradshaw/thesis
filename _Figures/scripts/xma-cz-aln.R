...
ch_seqs_path_nt <- "../_Data/constant/xma/xma_new_ch_nt_4trim.fasta"
ch_seqs_path_aa <- "../_Data/constant/xma/xma_new_ch_aa.fasta"

# Configure output
filename_base <- "xma-new-cz-aln"
...
savetab(cz_out_tab, filename_base)
