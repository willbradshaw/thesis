###############################################################################
## FIGURE                                                                    ##
## Plot alpha spectra of ageing whole-body repertoires                       ##
###############################################################################
...
tab_path_grouped_clone <- "../_Data/changeo/spectra/ageing_clone-diversity-grouped_seqs-all_copy-NULL.tsv"
tab_path_grouped_vj <- "../_Data/changeo/spectra/ageing_VJ-diversity-grouped_seqs-all_copy-NULL.tsv"
tab_path_solo_clone <- "../_Data/changeo/spectra/ageing_clone-diversity-solo_seqs-all_copy-NULL.tsv"
tab_path_solo_vj <- "../_Data/changeo/spectra/ageing_VJ-diversity-solo_seqs-all_copy-NULL.tsv"
...
# Output paths
filename_base <- "igseq-ageing-combined-diversity"
...
tab_grouped <- mutate(tab_grouped, 
                      AGE_DAYS = factor(sub(".*_", "", AGE_DAYS),
                                         levels = age_groups))
...
g_alpha <- plot_diversity_alpha(tab_grouped, "AGE_DAYS") +
  ...
  scale_fill_manual(values = palette, name = "Age (days)") +
