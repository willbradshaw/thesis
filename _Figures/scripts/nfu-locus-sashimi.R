...
bam_path <- "/home/will/Documents/data/igh/locus/star/2018-11-09_nfu-igh1c-masked_Aligned.sorted.bam"

# Configure output
filename <- "nfu-locus-sashimi"
...
altrack_cut <- AlignmentsTrack(bam_path,
                               ispaired = TRUE,
