...
# Input path
tab_path <- "../_Data/changeo/ctabs/gut_named.tab"
# TODO: Change to a path in the thesis directory

# Configure output
filename_nseq <- "gut-nseq-init"
filename_nreads <- "gut-nreads-init"
filename_vmean <- "gut-vscore-mean"
filename_vsd <- "gut-vscore-sd"
filename_base <- "gut-functional"
